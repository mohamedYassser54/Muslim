...
const Task9  = lazy(()=>import('./component/AllAlathkar/ramadan/tasks/task9'))
const Task10  = lazy(()=>import('./component/AllAlathkar/ramadan/tasks/task10'))
...
const Task16  = lazy(()=>import('./component/AllAlathkar/ramadan/tasks/task16'))
...
function App() {
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setTimeout(() => {
        toast("اللهم وفق طلاب الثانوية العامة يا ذا الجلال والإكرام، اللهم اجعل امتحاناتهم يسيرة ولا تجعلها عسيرة وأعطهم مرادهم، وأسأل الله العظيم رب العرش العظيم أن يوفق طلاب الثانوية العامة، ويكرمهم ويشرح صدورهم وييسر لهم أمورهم ويذكرهم ما نسوا ويفرح قلوبهم بالنجاح والتوفيق");
      }, 40000); 
      setTimeout(() => {
        toast("لا إله إلا أنت سبحانك إني كنت من الظالمين");
      }, 10000); 
    }, 10 * 60 * 1000); 
